...
velocidade = float(input("Qual a velocidade KM: "))
if velocidade > 80:
    print("Você foi multado")
    multa = (velocidade-80) *7
    print("A sua multa custara o valor de R$ {:.2f}".format(multa))
else:
    velocidade < 80
    print("Parabens você respeitou os limites de velocidade")
